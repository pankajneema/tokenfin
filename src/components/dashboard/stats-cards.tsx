...
/* ── Sparkline ──────────────────────────────────────────────── */
const FALLBACK = [4, 7, 5, 9, 6, 11, 8, 14, 10, 13, 9, 15, 12, 16]

function Sparkline({ data, color }: { data: number[]; color: string }) {
  const pts = data.length >= 2 ? data : FALLBACK
...
/* ═══════════════════════════════════════════════════════════════ */
export function StatsCards({ totalCost, totalTokens, totalRequests, memberCount, sparks }: Props) {
  const cards = [
    {
      label:     'Total Cost',
