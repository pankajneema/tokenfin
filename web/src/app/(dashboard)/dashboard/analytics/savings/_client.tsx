      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="rounded-2xl border border-dashed border-[var(--border)] p-10 text-center">
          ...
          <p className="mx-auto mt-1 max-w-md text-[12.5px] text-[var(--fg-secondary)]">
            Route a client through the TokenFin Gateway (<a className="text-teal underline" href="/dashboard/gateway">set it up here</a>) and savings will appear as traffic flows.
          </p>
        </div>
      </div>
    )
