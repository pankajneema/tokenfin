...
const INSTRUCTIONS =
  'TokenFin — read-only FinOps for your dashboard. (1) Analytics: get_spend, get_usage_by_model, ' +
  ...
  'Usage is captured automatically via OpenTelemetry — there is no write/record tool here.'
